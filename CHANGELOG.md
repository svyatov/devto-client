...
Every release is recorded here. Entries are generated by [release-please](https://github.com/googleapis/release-please) from the [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/) that land on `main`, which is why the groups are Features and Bug Fixes rather than hand-picked categories and why each entry links the commit behind it. That's the convention this file follows, and nothing in it is written by hand.

Versions follow [Semantic Versioning 2.0.0](https://semver.org/spec/v2.0.0.html). Which surface that promise actually covers, and which parts it deliberately doesn't, is declared in [CONTRIBUTING.md](CONTRIBUTING.md#what-semver-covers-here).

## [2.3.0](https://github.com/svyatov/devto-client/compare/v2.2.0...v2.3.0) (2026-09-24)


### Features

* re-sync the pinned spec, add events and openapi, accept array tags ([#45](https://github.com/svyatov/devto-client/issues/45)) ([2083c66](https://github.com/svyatov/devto-client/commit/2083c661bd3575476ddabfb13ae9fd7c67feff4d)), closes [#37](https://github.com/svyatov/devto-client/issues/37)


### Bug Fixes

* **spec-drift:** sort findings and commands so the issue body only changes with the findings ([#43](https://github.com/svyatov/devto-client/issues/43)) ([6fe48a5](https://github.com/svyatov/devto-client/commit/6fe48a566c30003dbd6eb87f5ac01fe031c769bf))
